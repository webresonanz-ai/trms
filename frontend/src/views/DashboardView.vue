<template>
    <div class="animate-fade-in-up">
        <div v-if="dashboard.loading" class="text-center py-5">
            <div class="spinner-border text-gold" role="status"></div>
            <p class="text-white-50 mt-2">Loading dashboard...</p>
        </div>
        <div v-else-if="dashboard.error" class="alert alert-danger">{{ dashboard.error }}</div>
        <template v-else>
